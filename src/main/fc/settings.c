...
// PG_STALKER_CONFIG
    ...
    { "stalker_distance_rate",      VAR_UINT8  | MASTER_VALUE, .config.minmax = { 1, 200  }, PG_STALKER_CONFIG, offsetof(stalkerConfig_t, distance_rate) },
    { "stalker_heading_rate",       VAR_UINT8  | MASTER_VALUE, .config.minmax = { 1, 200  }, PG_STALKER_CONFIG, offsetof(stalkerConfig_t, heading_rate) },
    { "stalker_rollyaw_ratio",      VAR_UINT8  | MASTER_VALUE, .config.minmax = { 0, 100  }, PG_STALKER_CONFIG, offsetof(stalkerConfig_t, rollyaw_ratio) },
